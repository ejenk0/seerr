...
const isCollection = (
  data: MovieDetails | TvDetails | Collection | MusicDetails | null
): data is Collection => {
  return (
    data !== null &&
    data !== undefined &&
...
const isMusic = (
  media: MovieDetails | TvDetails | Collection | MusicDetails | null
...
const isMovie = (
  ...
  if (!media) return false;
  return 'title' in media && !('artist' in media) && !isCollection(media);
};
...
const BlocklistModal = ({
  ...
  const [data, setData] = useState<
    MovieDetails | TvDetails | Collection | MusicDetails | null
  >(null);
